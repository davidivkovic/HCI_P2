...
namespace ThinkSharp.FeatureTouring
{
    ...
    internal class TourRun : ITourRun
    {
        ...
        {
            return $"Korak {myCurrentStepNode.StepNo}/{myTour.Steps.Length}";
        }
        ...
        private bool SetStep(StepNode nextStep, bool includeUnloaded = false)
        {
            ...
            if (app == null)
                ...
                element = app.Dispatcher.Invoke(DispatcherPriority.Normal, new Func<object>(() => myVisualElementManager.GetVisualElement(step.ElementID, includeUnloaded))) as VisualElement;
            if (element == null)
            {
